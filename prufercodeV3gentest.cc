...
{
  int phantu[MAX] = {0};      // so luong cua moi phan tu {0,...,n-1} xuat hien o dong duoi 
...
void gentest (int n, int tree [2][MAX])   // dao ngau nhien thu tu canh de xem prufer code con dung hay k
{
  int prufercode[MAX];
...
int main(int argc, char *argv[])    // phai nhap vao so dinh
{
